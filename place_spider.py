...
def spider_place(keyword, page):
    ...
    :return:
    """
    url = f'https://piao.qunar.com/ticket/list.json?keyword={keyword}&region=&from=mps_search_suggest&page={page}'
    headers = {
        ...
        'Host': 'piao.qunar.com',
        'Referer': 'https://piao.qunar.com/ticket/list.htm?keyword=%E4%B8%AD%E5%9B%BD%E6%97%85%E6%B8%B8%E6%99%AF%E7%82%B9&region=&from=mpl_search_suggest',
